...
class RatedMoviesViewController: UIViewController {
    ...
    func updateData() {
        ...
        MovieHandler.shared.getRatedMovies { (movies) in
            DispatchQueue.main.async {
...
extension RatedMoviesViewController: RatingDelegate {
...
extension RatedMoviesViewController: UICollectionViewDelegateFlowLayout {
...
extension RatedMoviesViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MovieCollectionViewCell", for: indexPath) as? MovieCollectionViewCell {
            let movie = self.ratedMovies[indexPath.row]
